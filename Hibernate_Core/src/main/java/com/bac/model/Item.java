...
public class Item implements Comparable<Item>, Serializable, Auditable {
	...
	public Item(String name, SimpleUser seller, SimpleUser buyer, String description, MonetaryAmount initialPrice,
			...
			Date approvalDatetime, List<Bid> bids, Bid successfulBid, Map<Long, Bid> bidsByIdentifier,
		...
		this.approvalDatetime = new Date(approvalDatetime.getTime());
		this.bids = bids;
	...
	public Date getApprovalDatetime() {
		return new Date(approvalDatetime.getTime());
	}
	...
	public void approve(SimpleUser byUser) throws BusinessException {
		...
		approvedBy = byUser;
		approvalDatetime = new java.sql.Date(new java.util.Date().getTime());
	}
